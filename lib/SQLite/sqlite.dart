...
class DatabaseHelper {
  ...
  String users =
      "create table users (usrId INTEGER PRIMARY KEY AUTOINCREMENT, usrName TEXT UNIQUE, usrclave TEXT)";
  ...
  Future<bool> login(Users user) async {
    ...
    var result = await db.rawQuery(
        "select * from users where usrUsuario = '${user.usrUsuario}' AND usrClave = '${user.usrClave}'");
